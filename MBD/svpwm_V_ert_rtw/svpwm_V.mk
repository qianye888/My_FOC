###########################################################################
## Makefile generated for component 'svpwm_V'. 
## 
## Makefile     : svpwm_V.mk
## Generated on : Sat Apr 26 10:05:41 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\svpwm_V.exe
...
COMPILER_COMMAND_FILE     = svpwm_V_comp.rsp
CMD_FILE                  = svpwm_V.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\svpwm_V.exe
...
DEFINES_STANDARD = -DMODEL=svpwm_V -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\svpwm_V_ert_rtw\svpwm_V.c

MAIN_SRC = $(START_DIR)\svpwm_V_ert_rtw\ert_main.c
...
{$(START_DIR)\svpwm_V_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\svpwm_V_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\svpwm_V_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\svpwm_V_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : "$(START_DIR)\svpwm_V_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\svpwm_V_ert_rtw\ert_main.c"


svpwm_V.obj : "$(START_DIR)\svpwm_V_ert_rtw\svpwm_V.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\svpwm_V_ert_rtw\svpwm_V.c"
