...
void FOC_step(void)
{
    ...
    {
        tmp_1 = (uint16_T)(rtU.Theta_Inte - rtU.Theta_zero);
    }
    else
    {
        tmp_1 = (uint16_T)((rtU.Theta_Inte - rtU.Theta_zero) + 4095);
    }
     ...
     *  Inport: '<Root>/Ud_input'
     *  Sum: '<S3>/Add1'
     */
    tmp = rtU.Ud_input * rtb_alpha_voltage;

    /* Product: '<S3>/Product1' incorporates:
     *  Gain: '<S7>/Gain1'
     *  Inport: '<Root>/Uq_input'
     */
    tmp_0 = rtU.Uq_input * rtb_Gain1;
     ...
     *  Inport: '<Root>/Ud_input'
     */
    tmp = rtU.Ud_input * rtb_Gain1;

    /* Product: '<S3>/Product3' incorporates:
     *  Inport: '<Root>/Uq_input'
     *  Sum: '<S3>/Add1'
     */
    tmp_0 = rtU.Uq_input * rtb_alpha_voltage;
